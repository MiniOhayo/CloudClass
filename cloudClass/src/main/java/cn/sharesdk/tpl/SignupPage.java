...
public class SignupPage extends FakeActivity implements OnClickListener,
		Callback {
		...
		case MSG_SHOW_TOAST:
			if (signupListener != null) {
				...
				if (signupListener.onSignUp(userInfo)) {
					Toast.makeText(activity, R.string.signup_success,
							Toast.LENGTH_SHORT).show();
					finish();
				} else {
					Toast.makeText(activity, R.string.signup_failed,
							Toast.LENGTH_SHORT).show();
				}
			}
			break;
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == INTENT_ACTION_PICTURE
			...
			Cursor c = activity.getContentResolver().query(data.getData(),
					null, null, null, null);
			c.moveToNext();
	...
	private void showChangeIconDialog() {
		...
		dialog.findViewById(R.id.dialog_camera).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						dialog.dismiss();
		...
		dialog.findViewById(R.id.dialog_picture).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						dialog.dismiss();
	...
	private void showGerderDialog() {
		...
		final ImageView ivBoy = (ImageView) dialog
				.findViewById(R.id.dialog_iv_boy);
		final ImageView ivGirl = (ImageView) dialog
				.findViewById(R.id.dialog_iv_girl);
		...
		dialog.findViewById(R.id.rl_boy).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						ivGirl.setVisibility(View.GONE);
		...
		dialog.findViewById(R.id.rl_girl).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						ivGirl.setVisibility(View.VISIBLE);
	...
	private void showChangeInfo(final ChangeUserType type) {
		...
		View dlgView = View.inflate(activity,
				R.layout.tpl_change_userinfo_dialog, null);
		...
		final EditText etInfo = (EditText) dialog
				.findViewById(R.id.dialog_ev_info);
		final TextView tvHint = (TextView) dialog
				.findViewById(R.id.dialog_tv_hint);
		tvTitle.setText(title);
		etInfo.setText(content);
		tvHint.setText(hint);
		dialog.findViewById(R.id.dialog_btn_save).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
