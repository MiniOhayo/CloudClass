...
public class AcFavorite extends Activity implements OnItemClickListener,
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ac_favorite);
		initeView();
			...
			if (!isSelected) {
				...
				new Thread() {
					...
					public void run() {
						...
						ReturnInfo ret = ApiUtils.uploadFavoriteRecordsByUser(
	...
	void getData(final String id, final int pageNum) {
		new Thread() {
			...
			public void run() {
				// TODO Auto-generated method stub
				GetCoursesInfo response = ApiUtils.getFavoriteRecordsByUser(id,
						pageNum, handler);
