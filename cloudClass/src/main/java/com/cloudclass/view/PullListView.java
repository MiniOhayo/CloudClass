...
public class PullListView extends ListView implements OnScrollListener {
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			lvHeaderTipsTv.setText(context.getString(R.string.smooth_fresh));
			break;
		case PULL_To_REFRESH:
			...
			if (isBack) {
				...
				lvHeaderTipsTv.setText(context
						.getString(R.string.pull_down_fresh));
			} else {
				lvHeaderTipsTv.setText(context
						.getString(R.string.pull_down_fresh));
			}
		...
		case REFRESHING:
			...
			lvHeaderTipsTv.setText(context.getString(R.string.freshing));
			lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
			break;
		case DONE:
			headerView.setPadding(0, -1 * headerContentHeight, 0, 0);
			...
			lvHeaderTipsTv.setText(context.getString(R.string.pull_down_fresh));
			lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
			break;
		}
	}
	...
	public void onRefreshComplete() {
		state = DONE;
		lvHeaderLastUpdatedTv.setText(context.getString(R.string.last_fresh)
