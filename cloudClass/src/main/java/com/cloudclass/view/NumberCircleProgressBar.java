...
public class NumberCircleProgressBar extends View {
	...
	private int mUnreachedBarCenterColor;
	 ...
	 */
	private Paint mCirclePaint,mCircleCenterPaint;
	...
	public NumberCircleProgressBar(Context context, AttributeSet attrs,
		...
		try {
			...
			mUnreachedBarCenterColor = attributes
					.getColor(
							R.styleable.NumberCircleProgressBar_progress_unreached_center_color,
							DEFAULT_UNREACHED_COLOR);
	...
	protected void onDraw(Canvas canvas) {
		...
		mCircleCenterPaint.setStyle(Paint.Style.FILL);
		mSectorPaint.setStyle(Paint.Style.FILL);

		// draw the circle
		canvas.drawCircle(centerX, centerY, mCircleRadius, mCirclePaint);
		canvas.drawCircle(centerX, centerY, mCircleRadius-10, mCircleCenterPaint);
		if (mDrawReachedBar) {
			switch (mFillMode) {
			case 0:
	...
	private void initializePainters() {
		...
		mCircleCenterPaint.setColor(mUnreachedBarCenterColor);
		mCircleCenterPaint.setStyle(Paint.Style.FILL);
