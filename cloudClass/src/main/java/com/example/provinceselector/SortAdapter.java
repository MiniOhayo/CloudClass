...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			viewHolder.imgFace = (ImageView) view.findViewById(R.id.face_icon);
		...
		viewHolder.tvInfo.setText(mContent.getInfo());
		viewHolder.tvTitle.setText(this.list.get(position).getName());
		if (!TextUtils.isEmpty(mContent.getImage())) {
			NetUtils.loadImage(mContext,mContent.getImage(), NetUtils.TiNE_IMAGE,
					viewHolder.imgFace);
		}
